...
See this [test case](https://github.com/growbit/turbogwt-gwtp/tree/master/src/test/java/org/turbogwt/ext/gwtp/databind/test/person) for a more complete example.
